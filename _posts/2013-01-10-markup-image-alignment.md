...
![image-left]({{ site.url }}{{ site.baseurl }}/assets/images/bio-photo.jpg){: .align-left} The rest of this paragraph is filler for the sake of seeing the text wrap around the 150×150 image, which is **left aligned**.
